...
| `Bridges` | Cross-literature and cross-layer bridges: graph-to-spectral correspondences, ELK/deception/AI-control interfaces, and decomposition attack retagging. | 3638 | 10 | `GraphSpectralCorrespondence`, `graph_strategyproof_iff_zero_consistency_vulnerability`, `AIControlProtocol`, `decomposition_attack_blocked_or_sacrificed` | supporting |
...
| `Protocol` | Formal protocol state, compilation witnesses, drift/corrigibility transitions, risk reports, and multi-principal corrigibility bridges. | 4413 | 11 | `CompiledGovernance`, `compileGovernance`, `corrigibility_under_recompile`, `MultiPrincipalSystem` | supporting |
...
| `Results` | Public theorem facade and finite audit lanes: semantic bridge, capability scaling, admissibility audits, leaderboard witnesses, and ASI packages. | 12890 | 37 | `semanticKernel_iff_runtime_diagnostic_spectral_layers`, `capability_scaling_shared_cliff`, `codexHooksGovernanceAdmissibilityRejectsMonotonicity`, `governanceAdmissibilityVerdict` | headline |
